...
public class GradesPanel extends JPanel {
    ...
    public GradesPanel(MainDashboard dashboard, StudentManager manager) {
    ...
    private JPanel createFormPanel() {
        ...
        JLabel headerLabel = new JLabel("Grades Management");
    ...
    private JPanel createTablePanel() {
        ...
        String[] columns = {"Student ID", "Student Name", "Department", "Marks", "Calculated Grade", "Current Grade"};
    ...
    private void handleSearch() {
        ...
        if (currentStudent == null) {
            ...
            calcGradeLabel.setText(autoGrade);
    ...
    private void handleUpdate() {
        ...
        if (updated) {
            calcGradeLabel.setText(Student.calculateGrade(currentStudent.getMarks()));
    ...
    public void refreshTable(ArrayList<Student> students) {
        ...
        for (int i = 0; i < students.size(); i++) {
            ...
            Object[] row = {
                ...
                Student.calculateGrade(s.getMarks()),
                s.getGrade()
            };
            model.addRow(row);
        }
